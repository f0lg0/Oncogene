...
def mainMenu():
    ...
    print(f"{colors.OKGREEN}--kill" + f"{colors.ENDC} : Kill processes")
    print(f"{colors.OKGREEN}--msg" + f"{colors.ENDC} : Open message box")
    print(f"{colors.OKGREEN}--lock" + f"{colors.ENDC} : Lock PC")
